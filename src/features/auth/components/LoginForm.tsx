    ...
    return (
        <div className="space-y-6">
            <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-2">{t('auth.selectAccountType')}</h2>
                <p className="text-gray-600">{t('auth.chooseHowToRegister')}</p>
            </div>
